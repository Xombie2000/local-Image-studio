# Patch: mflux/models/common/config/model_config.py (SeedVR2 section)
# Source: mflux 0.19.1 + MLX 0.32.2
# Purpose: ModelConfig.seedvr2_7b() definition
#
212:    def seedvr2_3b() -> "ModelConfig":
213:        return AVAILABLE_MODELS["seedvr2-3b"]
217:    def seedvr2_7b() -> "ModelConfig":
218:        return AVAILABLE_MODELS["seedvr2-7b"]
681:    "seedvr2-3b": ModelConfig(
683:        aliases=["seedvr2-3b", "seedvr2"],
727:    "seedvr2-7b": ModelConfig(
729:        aliases=["seedvr2-7b", "seedvr2-7B"],
---
...
AVAILABLE_MODELS = {
    ...
    "ernie-image-turbo": ModelConfig(
        ...
        num_train_steps=1000,
        max_sequence_length=2048,
        supports_guidance=False,  # guidance-distilled: the CLI errors on anything but 1.0
        requires_sigma_shift=True,
        sigma_base_shift=1.3863,
        sigma_max_shift=1.3863,
